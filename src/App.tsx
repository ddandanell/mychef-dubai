...
const DropOffCatering = lazy(() => import('./pages/DropOffCatering'))
const TastingMenu = lazy(() => import('./pages/TastingMenu'))
...
const GraduationCatering = lazy(() => import('./pages/GraduationCatering'))
const FarewellCatering = lazy(() => import('./pages/FarewellCatering'))
const ReunionCatering = lazy(() => import('./pages/ReunionCatering'))
const FathersDayCatering = lazy(() => import('./pages/FathersDayCatering'))
const ChineseNewYearCatering = lazy(() => import('./pages/ChineseNewYearCatering'))
const HoliCatering = lazy(() => import('./pages/HoliCatering'))
const PicnicCatering = lazy(() => import('./pages/PicnicCatering'))
const CoffeeTeaService = lazy(() => import('./pages/CoffeeTeaService'))
...
const UniversityCatering = lazy(() => import('./pages/UniversityCatering'))
const HealthcareCatering = lazy(() => import('./pages/HealthcareCatering'))
...
const SugarFreeCatering = lazy(() => import('./pages/SugarFreeCatering'))
const FodmapCatering = lazy(() => import('./pages/FodmapCatering'))
    ...
    <Layout>
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/drop-off-catering-dubai" element={<DropOffCatering />} />
          <Route path="/tasting-menu-dubai" element={<TastingMenu />} />
          ...
          <Route path="/graduation-catering-dubai" element={<GraduationCatering />} />
          <Route path="/farewell-catering-dubai" element={<FarewellCatering />} />
          <Route path="/reunion-catering-dubai" element={<ReunionCatering />} />
          <Route path="/fathers-day-catering-dubai" element={<FathersDayCatering />} />
          <Route path="/chinese-new-year-catering-dubai" element={<ChineseNewYearCatering />} />
          <Route path="/holi-catering-dubai" element={<HoliCatering />} />
          <Route path="/picnic-catering-dubai" element={<PicnicCatering />} />
          <Route path="/coffee-tea-service-dubai" element={<CoffeeTeaService />} />
          ...
          <Route path="/university-catering-dubai" element={<UniversityCatering />} />
          <Route path="/healthcare-catering-dubai" element={<HealthcareCatering />} />
          ...
          <Route path="/sugar-free-catering-dubai" element={<SugarFreeCatering />} />
          <Route path="/fodmap-catering-dubai" element={<FodmapCatering />} />
