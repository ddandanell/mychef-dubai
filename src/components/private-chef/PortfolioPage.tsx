...
export default function PortfolioPage({caseStudy=false}:{caseStudy?:boolean}){
 ...
 return <div><SEO title={caseStudy?'Catering Case Studies Dubai | Previous Work | myCHEF':'Event Gallery | Previous Work & Dining Inspiration | myCHEF'} description={caseStudy?'Real myCHEF event work in Dubai: yacht catering, villa dinners and staffed receptions, photographed as they were served. See how menus, service and setup come together.':'Browse previous myCHEF yacht service and a collection of dining, household and occasion inspiration for planning your own event in Dubai.'} canonicalPath={caseStudy?'/case-studies':'/gallery'}/>
