...
export const officeFaqs = [
  ...
  {
    q: 'Do you handle daily office lunch Dubai?',
  ...
  {
    q: 'Do you handle office lunch catering Dubai?',
    a: 'Yes. For companies we work to a fixed timing, invoice properly, cater dietary requirements per employee and keep the set-up clean and quick. Budgets typically start around AED 90 per person. One contact, one itemised quote, and the same team every time if you want continuity.',
  },
  {
    q: 'Do you handle team lunch catering Dubai?',
    a: 'Yes. For companies we work to a fixed timing, invoice properly, cater dietary requirements per employee and keep the set-up clean and quick. Budgets typically start around AED 90 per person. One contact, one itemised quote, and the same team every time if you want continuity.',
  },
  {
    q: 'Do you handle weekly office catering Dubai?',
    a: 'Yes. For companies we work to a fixed timing, invoice properly, cater dietary requirements per employee and keep the set-up clean and quick. Budgets typically start around AED 90 per person. One contact, one itemised quote, and the same team every time if you want continuity.',
  },
  {
    q: 'Do you handle corporate lunch delivery Dubai?',
    a: 'Yes. For companies we work to a fixed timing, invoice properly, cater dietary requirements per employee and keep the set-up clean and quick. Budgets typically start around AED 90 per person. One contact, one itemised quote, and the same team every time if you want continuity.',
  },
  {
    q: 'Do you handle office food delivery Dubai?',
    a: 'Yes. For companies we work to a fixed timing, invoice properly, cater dietary requirements per employee and keep the set-up clean and quick. Budgets typically start around AED 90 per person. One contact, one itemised quote, and the same team every time if you want continuity.',
  },
  {
    q: 'Do you offer office catering packages Dubai?',
    a: 'Yes. We start from set formats and adjust them to your event rather than selling a fixed box: menu length, service style, staff and equipment are chosen for the day. Starting points begin at AED 90 per person. Ask for the format closest to what you are planning and we shape it from there.',
  },
  {
    q: 'What makes myCHEF a strong choice for luxury office catering Dubai?',
