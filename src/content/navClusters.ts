...
const CORPORATE_NAV_GROUPS_RAW: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/brand-activation-catering-dubai', label: 'Brand Activation', description: 'Pop-up, sampling, street' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/corporate-retainer-dubai', label: 'Corporate Retainer', description: 'Monthly account, recurring meals' },
