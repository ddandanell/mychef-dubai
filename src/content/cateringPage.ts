...
export const cateringFaqs = [
  ...
  {
    q: 'Do you offer catering services Dubai?',
    a: 'Yes. It sits inside the same service as catering Dubai: we design the menu around your event, bring the chef and team to your address, and quote it itemised so you can see what each part costs. Tell us the date and headcount and we recommend the format. If you searched for catering services in Dubai, this is the same service.',
  },
  {
    q: 'Do you offer food catering Dubai?',
    a: 'Yes. It sits inside the same service as catering Dubai: we design the menu around your event, bring the chef and team to your address, and quote it itemised so you can see what each part costs. Tell us the date and headcount and we recommend the format.',
  },
  {
    q: 'Do you provide home catering Dubai?',
  ...
  {
    q: 'Do you cater catering Dubai party?',
  ...
  {
    q: 'Do you offer catering service in Dubai?',
    a: 'Yes. It sits inside the same service as catering Dubai: we design the menu around your event, bring the chef and team to your address, and quote it itemised so you can see what each part costs. Tell us the date and headcount and we recommend the format.',
  },
  {
    q: 'Do you cater small catering Dubai party?',
    a: 'Yes. We plan the menu around the occasion and the room — plated, buffet, canapés or live stations — bring chefs, service staff and equipment, and handle the clear-down. Share the date, guest count and venue and you get a proposal with the format we would recommend and why.',
  },
  {
    q: 'Do you offer full service catering Dubai?',
    a: 'Yes. It sits inside the same service as catering Dubai: we design the menu around your event, bring the chef and team to your address, and quote it itemised so you can see what each part costs. Tell us the date and headcount and we recommend the format.',
  },
  {
    q: 'Do you offer catering services Dubai?',
