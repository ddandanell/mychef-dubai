...
function dropOff(
  ...
  return {
    ...
    minOrderAed: 900,
    includedStaff: 'None. Your team serves itself.',
    includedEquipment: 'Sealed packaging, serving tongs, napkins and labels.',
    delivery: 'Delivered and laid out. Collection of empties on request.',
...
export const CORPORATE_PACKAGES: readonly CorporatePackage[] = [
  ...
  dropOff({
    ...
    portionNote: 'One labelled box per seat. Devices stay off the table.',
  ...
  plated({
    ...
    portionNote: 'Courses at the table. Chef-led plated band, not the AED 90 drop-off lunch.',
  ...
  dropOff({
    ...
    portionNote: 'One break sitting per delegate. Barista labour is not a full coffee-cart package unless named.',
  ...
  buffet({
    ...
    portionNote: 'Break plus lunch allowances for each delegate. Unusual venue costs are separate.',
  ...
  buffet({
    ...
    portionNote: 'Two breaks and lunch per delegate. Stations planned to the room, not to AV.',
    serviceDuration: 'One conference day. Holding across sessions is included in the staffed format.',
  }),
  proposal({
  ...
  canape({
    ...
    portionNote: 'Food that can pause for the reveal. Not a seated dinner.',
  ...
  dropOff({
    ...
    portionNote: 'No on-stand kitchen assumed. Holding and replenishment planned for the hall rules.',
  ...
  dropOff({
    ...
    portionNote: 'One meal per crew member per named sitting.',
  ...
  }),
  {
    ...
    portionNote: 'Whole-event price for 10–15 guests. Not multiplied by headcount. Not the AED 700–950 plated band.',
    pricingUnit: 'package',
    minGuests: 10,
    maxGuests: 15,
    ...
    exclusions: [
      ...
      'A two-person date-night dinner',
  ...
  plated({
    ...
    portionNote: 'Per-person plated band. Different product from the AED 4,500 package for 10–15 guests.',
  ...
  buffet({
    ...
    portionNote: 'Seated service with a clock. Wine only where the venue licence allows it.',
  ...
  dropOff({
    ...
    portionNote: 'Volume meals for a known headcount. Not waiter recruitment and not a gala.',
    serviceDuration: 'Named sittings per week.',
    bookingNotice: NOTICE_OFFICE,
  }),
  dropOff({
    id: 'corp-staff-shift',
    ...
    portionNote: 'Billed on actual service sittings, not a calendar month of empty days.',
  ...
  dropOff({
    ...
    sampleMenu: ['Holding snacks', 'Fruit', 'Hot drinks', 'Water'],
    portionNote: 'Craft table, not a seated dinner. Call-sheet timing matters more than styling.',
  ...
  dropOff({
    ...
    portionNote: 'One lunch per crew member on the call sheet.',
  ...
  canape({
    ...
    portionNote: 'Food supports the brand moment. It does not sit on laptops or compete with the product.',
