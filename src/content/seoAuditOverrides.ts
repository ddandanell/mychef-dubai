// Search metadata overrides. Keep aligned with the SEO contract and page content.
...
export const SEO_AUDIT_OVERRIDES: Record<string, SeoAuditOverride> = {
  ...
  "/blog/nut-free-halal-nursery-meals-dubai": {
    "title": "Nut-Free Nursery Meals Dubai | myCHEF",
    "description": "Questions to ask about nut exclusions, allergen controls, halal sourcing and nursery meal documentation in Dubai before confirming a catering service."
  },
  ...
  "/trust-and-programs": {
    "title": "myCHEF Service Standards & Support"
  },
  ...
  "/desert-dining-dubai": {
    ...
    "description": "Desert dining Dubai: a private chef cooks at a desert table you book. Chef-led plated dining AED 700–950 per person, with service and clear-down."
  },
  "/bar-services-dubai": {
  ...
  "/eid-catering-dubai": {
    ...
    "description": "Eid catering Dubai for Eid al-Fitr and Eid al-Adha at home or a majlis. Halal menus, ouzi when needed. Buffet from AED 120. Itemised quote."
  },
  ...
  "/blog": {
    ...
    "description": "The myCHEF Dubai blog: private chef and catering guides, published prices, and how a night is actually run. Written for hosts, not a keyword list."
  },
  ...
  "/influencer-partnerships": {
    ...
    "description": "Food influencer partnerships Dubai: a chef-led night for content, quoted as a booking. Terms in writing. We typically reply within 15 minutes."
  },
  ...
  "/dessert-table-catering-dubai": {
    ...
    "description": "Dessert table catering Dubai: cake, patisserie and a styled sweet table, built on site and packed down. Quoted with the rest of the catering."
  },
  "/chefs/ahmed-executive-chef": {
    "title": "Ahmed Al-Rashid | Partner Chef Dubai | myCHEF",
    "description": "Ahmed Al-Rashid is an independent partner chef in the myCHEF Dubai network. Classical French technique in villas, homes and plated corporate dinners."
  },
  ...
  "/founding-customer-offer": {
    ...
    "description": "myCHEF founding customer offer: Silver from AED 2,500 a year, Gold from AED 5,500, Platinum from AED 12,000. Rate locked 12 months. Chef quoted separately."
  },
  "/chefs/matteo-pastry-chef": {
    "title": "Private Pastry Chef Dubai | Matteo Moretti | myCHEF",
    "description": "Private pastry chef Dubai: Matteo Moretti plates desserts and dessert tables in your kitchen. Independent partner chef. You approve the profile first."
  },
  "/blog/brunch-at-home-dubai": {
    "title": "Brunch at Home Dubai: A Hosting Guide | myCHEF",
    "description": "Plan brunch at home in Dubai with menu ideas, service options, kitchen checks and clear pricing questions for a relaxed morning with guests."
  },
  "/blog/desert-dinner-party-dubai": {
    "title": "Desert Dinner Party Dubai: Planning Guide | myCHEF",
    "description": "Plan a desert dinner party in Dubai with practical guidance on venue permission, access, cooking facilities, menus and service."
  },
  "/blog/dinner-party-menu-ideas-dubai": {
    "title": "Dinner Party Menu Ideas Dubai | myCHEF",
    "description": "Dinner party menu ideas for Dubai homes: choose a balanced sequence of dishes, plan dietary needs and compare sharing or plated service."
  },
  "/blog/dubai-school-food-rules-2026": {
    "title": "Dubai School Food Rules 2026 | myCHEF",
    "description": "A practical checklist for verifying Dubai school food requirements, provider approvals, menus, allergen information and responsibilities in 2026."
  },
  "/blog/grazing-table-vs-buffet-dubai": {
    "title": "Grazing Table vs Buffet Dubai: How to Choose | myCHEF",
    "description": "Compare grazing tables and buffets for Dubai events, including portions, service time, replenishment and the questions to ask before booking."
  },
  "/blog/how-far-ahead-book-caterer-dubai": {
    "title": "How Far in Advance to Book a Caterer Dubai | myCHEF",
  ...
  "/blog/iftar-at-home-dubai": {
    ...
    "description": "Plan iftar at home in Dubai with a considered menu, service timed for Maghrib and clear questions about preparation, dietary needs and pricing."
  },
  "/blog/nursery-meals-vs-packed-lunch-dubai": {
    "title": "Nursery Meals vs Packed Lunch Dubai | myCHEF",
    "description": "Compare provided nursery meals and packed lunches in Dubai, including dietary communication, storage, parent information and service responsibilities."
  },
  "/blog/nye-party-catering-dubai": {
    "title": "NYE Party Catering Dubai: Planning Guide | myCHEF",
    "description": "Plan New Year’s Eve catering in Dubai, from canapés and live stations to midnight service, with venue access and complete pricing confirmed."
  },
  "/blog/private-chef-date-night-dubai": {
    "title": "Private Chef Date Night Dubai | myCHEF",
    "description": "Plan a private chef date night in Dubai with a three-course dinner for two, menu preferences, kitchen checks and clear package inclusions."
  },
  "/blog/private-chef-vs-restaurant-dubai": {
    "title": "Private Chef vs Restaurant Dubai | myCHEF",
    "description": "Compare a private chef and restaurant dining in Dubai by setting, menu flexibility, service, preparation and the complete cost of your occasion."
  },
  "/blog/vegan-catering-dubai-guide": {
    "title": "Vegan Menu Ideas Dubai | myCHEF",
