...
const pressFaqs = [
  ...
  },
  {
    ...
    a: 'We can arrange interviews with the myCHEF Dubai founder, head of operations, or one of our vetted executive chefs. Reach out to info@mychef.ae with your deadline.',
  },
  {
      ...
      <section className="press-cta opacity-0 translate-y-8 bg-black py-20">
        <div className="container-custom text-center max-w-[700px]">
          ...
          <p className="mt-6 font-inter text-body-sm text-gray-500">
            Or email us at{' '}
            <a href="mailto:info@mychef.ae?subject=Press%20enquiry%20-%20myCHEF%20Dubai" className="text-gold hover:text-gold-light underline underline-offset-4">
              info@mychef.ae
            </a>
          </p>
        </div>
