...
const config: DietaryPageConfig = {
  ...
  metaDescription:
    'Book nut-free catering in Dubai. Allergy-safe menus for schools, birthdays, corporate events and family gatherings with clear labelling. Get a tailored quote in 15 minutes.',
