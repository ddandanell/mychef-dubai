...
export default function KidsNutritionChef() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Kids Nutrition Chef Dubai | Healthy Family Meal Prep | myCHEF"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="kn-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="kn-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
