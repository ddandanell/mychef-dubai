      ...
      <article className="bg-white section-padding">
        <div className="article-body container-custom max-w-[820px]">
          ...
          <section className="article-section opacity-0 translate-y-8 mb-12">
            ...
            <p className="font-inter text-body text-gray-500 leading-relaxed mb-5">
              Private dining chef near me is covered across the whole city, because the chef travels to your address rather than the other way round. If you are weighing up best private dining rooms Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. The halal private dining menu and Palm Jumeirah villa dining menu are drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Private chef Palm Springs is the same booking: a vetted chef, matched to your kitchen and your menu. Coya Dubai private dining and carbone Dubai private dining are the same service under another name.
            </p>
            <p className="font-inter text-body text-gray-500 leading-relaxed mb-5">
