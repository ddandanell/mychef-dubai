...
export default function PartTimePrivateChef() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Part-Time Private Chef Dubai | 2–3 Days Per Week"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="pt-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="pt-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
