          ...
          <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-y-12 lg:gap-x-12">
            <div className="bmc-form-left">
              ...
              <div className="mt-6 flex flex-col gap-3">
                ...
                <div className="flex items-start gap-3">
                  <Check size={16} className="text-gold mt-1 flex-shrink-0" />
                  <span className="font-inter text-body-sm text-gray-500">Prefer email? Send your CV to <a href="mailto:info@mychef.ae" className="text-gold hover:text-gold-light underline underline-offset-4">info@mychef.ae</a>.</span>
                </div>
              </div>
            </div>
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          <h2 className="font-playfair text-fluid-h2 text-black text-center mb-10">
            Private Chef Jobs Dubai: the questions we get before a booking
          </h2>
