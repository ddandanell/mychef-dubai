...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Office Catering Dubai', item: 'https://www.mychef.ae/office-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'd like a Office quote in Dubai. Date: __ Guests: __ Area: __"
export default function OfficeCatering() {
  ...
  return (
    <div ref={containerRef}>
      ...
      <LocationStrip title="Office catering across Dubai" />
