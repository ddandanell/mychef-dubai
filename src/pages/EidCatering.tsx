    ...
    <div ref={containerRef}>
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
            Eid catering Dubai price and Eid catering cost per person Dubai depend on the same three things: the guest count, the menu, and how much of the work happens in front of people. Eid catering packages Dubai and Eid lunch offers in Dubai start from a set format and get adjusted to your date rather than sold as a fixed box. If you are weighing up best Eid catering Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. The Eid catering menu Dubai is drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Eid Al fitr catering Dubai and Eid Al adha catering Dubai are planned around the room and the running order, with chefs, service staff and clear-down included.
          </p>
