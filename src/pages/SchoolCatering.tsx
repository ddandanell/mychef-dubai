...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'School Catering Dubai', item: 'https://www.mychef.ae/school-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'd like a School quote in Dubai. Date: __ Guests: __ Area: __"
export default function SchoolCatering() {
  ...
  return (
    <div ref={containerRef}>
      ...
      <LocationStrip title="School catering across Dubai" />
