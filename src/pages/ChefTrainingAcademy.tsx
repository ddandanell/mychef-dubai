...
export default function ChefTrainingAcademy() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Chef Training Academy Dubai | MyChef Certification | myCHEF"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="ct-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="ct-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
