...
const galleryImages = [
  { src: '/menu-seafood.webp', alt: 'Mediterranean grilled seafood catering in Dubai' },
  { src: '/menu-appetizer.webp', alt: 'Greek mezze appetizer spread' },
  { src: '/service-luxury-dining.webp', alt: 'Mediterranean luxury dining setup in Dubai' },
  { src: '/menu-canapes.webp', alt: 'Mediterranean canapé selection' },
  { src: '/service-events.webp', alt: 'Mediterranean event catering in Dubai' },
  { src: '/menu-dessert.webp', alt: 'Mediterranean dessert and pastry display' },
]
            ...
            {menuHighlights.map((fmt, i) => {
              ...
              return (
                <Link
                  key={i}
                  to={fmt.link}
                  className="med-fmt-card group bg-charcoal p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
                >
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="med-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="med-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
          ...
          <div className="med-loc-grid grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {locations.map((loc) => (
              <Link
                ...
                className="med-loc-item flex items-center gap-2 font-inter text-sm text-gray-400 hover:text-gold transition-colors opacity-0"
              >
