...
const menuHighlights = [
  ...
  {
    icon: Flame,
    title: 'Chargrilled Mains',
    description: 'Souvlaki, lamb kleftiko, herb-marinated chicken, and grilled halloumi, cooked over flame and finished with citrus and oregano.',
  ...
  {
    icon: Leaf,
    title: 'Plant-Forward Dishes',
    description: 'Stuffed vegetables, gigantes beans, and vibrant vegetable mezze make Mediterranean menus naturally generous for vegetarian and vegan guests.',
...
const useCases = [
  {
    title: 'Summer & Poolside Events',
    description: 'Light, fresh, and naturally suited to warm weather, Mediterranean menus are a favourite for poolside parties, garden lunches, and beachside gatherings across Dubai where guests want flavour without heaviness.',
  },
  {
  ...
  },
  {
    ...
    description: 'Relaxed sharing menus of mezze, grills, and seafood platters suit villa terraces and family days, where guests serve themselves and the table stays generous all afternoon.',
  },
  {
    title: 'Corporate & Refined Dining',
    description: 'Elegant plated Mediterranean courses bring a coastal, considered feel to corporate lunches and refined receptions, presented with the polish a professional setting calls for.',
  },
]
...
const galleryImages = [
  { src: '/menu-seafood.jpg', alt: 'Mediterranean grilled seafood catering in Dubai' },
  { src: '/menu-appetizer.jpg', alt: 'Greek mezze appetizer spread' },
  { src: '/service-luxury-dining.jpg', alt: 'Mediterranean luxury dining setup in Dubai' },
  { src: '/menu-canapes.jpg', alt: 'Mediterranean canapé selection' },
  { src: '/service-events.jpg', alt: 'Mediterranean event catering in Dubai' },
  { src: '/menu-dessert.jpg', alt: 'Mediterranean dessert and pastry display' },
]
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Absolutely. Mediterranean cuisine is naturally plant-forward, so we build generous vegetarian and vegan menus from stuffed vegetables, beans, salads, and mezze, alongside seafood and meat for mixed groups.',
  },
  {
    q: 'Is the meat halal?',
    a: 'Yes. Halal meat and poultry are standard across our Mediterranean catering in Dubai, sourced from trusted suppliers. Halal is the baseline for our menus and we are glad to confirm sourcing details when you plan.',
  },
  {
    q: 'Do you offer seafood platters and grilled fish?',
    a: 'We do. Grilled whole fish, sea bass, octopus, prawns, and shared seafood platters are a centrepiece of our Mediterranean menus, dressed simply with lemon, herbs, and good olive oil.',
  },
  {
...
const relatedServices = [
  ...
  },
  {
    ...
    description: 'Handmade pasta, risotto, and antipasti with a live pasta station for your guests.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Mediterranean Catering Dubai', item: 'https://mychef.ae/mediterranean-catering-dubai' },
  ],
}
...
export default function MediterraneanCatering() {
  ...
  useGSAP(() => {
    ...
    gsap.to('.med-hero-h1', { opacity: 1, y: 0, duration: 0.8, ease: 'power3.out' })
    gsap.to('.med-hero-sub', { opacity: 1, y: 0, duration: 0.6, delay: 0.3, ease: 'power3.out' })
    gsap.to('.med-hero-cta', { opacity: 1, y: 0, duration: 0.5, stagger: 0.15, delay: 0.6, ease: 'power3.out' })

    gsap.to('.med-fmt-card', {
      scrollTrigger: { trigger: '.med-fmt-grid', start: 'top 85%', toggleActions: 'play none none none' },
      opacity: 1, y: 0, duration: 0.8, stagger: 0.1, ease: 'power3.out',
    })

    gsap.to('.med-uc-item', {
      scrollTrigger: { trigger: '.med-uc-grid', start: 'top 85%', toggleActions: 'play none none none' },
      opacity: 1, y: 0, duration: 0.7, stagger: 0.08, ease: 'power3.out',
    })

    gsap.to('.med-inc-item', {
      scrollTrigger: { trigger: '.med-inc-grid', start: 'top 85%', toggleActions: 'play none none none' },
      opacity: 1, x: 0, duration: 0.6, stagger: 0.08, ease: 'power3.out',
    })

    gsap.to('.med-gallery-img', {
      scrollTrigger: { trigger: '.med-gallery', start: 'top 85%', toggleActions: 'play none none none' },
      opacity: 1, scale: 1, duration: 0.6, stagger: 0.06, ease: 'power3.out',
    })

    gsap.to('.med-faq-item', {
      scrollTrigger: { trigger: '.med-faq', start: 'top 85%', toggleActions: 'play none none none' },
      opacity: 1, y: 0, duration: 0.5, stagger: 0.08, ease: 'power3.out',
    })

    gsap.to('.med-loc-item', {
      scrollTrigger: { trigger: '.med-loc-grid', start: 'top 85%', toggleActions: 'play none none none' },
      opacity: 1, duration: 0.5, stagger: 0.04, ease: 'power3.out',
    })

    gsap.to('.med-rel-card', {
      scrollTrigger: { trigger: '.med-rel-grid', start: 'top 85%', toggleActions: 'play none none none' },
      opacity: 1, y: 0, duration: 0.8, stagger: 0.1, ease: 'power3.out',
    })

    gsap.to('.med-cta', {
      scrollTrigger: { trigger: '.med-cta', start: 'top 85%', toggleActions: 'play none none none' },
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Mediterranean Catering Dubai | Seafood & Mezze"
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center bg-black overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'url(/menu-seafood.jpg)' }}
        />
        <div className="absolute inset-0 bg-black/50" />

        <div className="relative z-10 container-custom text-center max-w-[800px] py-20">
          <nav className="mb-6 opacity-0 translate-y-4 med-hero-h1">
            <ol className="flex items-center justify-center gap-2 font-inter text-[13px]">
              ...
              <li><span className="text-gold">Mediterranean Catering Dubai</span></li>
            </ol>
          </nav>

          <h1 className="font-playfair text-[40px] md:text-[56px] lg:text-[72px] font-semibold text-white leading-tight mb-6 opacity-0 translate-y-10 med-hero-h1">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/inquiry?utm_source=mychef.ae&utm_medium=cta_button&utm_campaign=mediterranean-catering-dubai" className="btn-primary opacity-0 translate-y-4 med-hero-cta">Request a Proposal</Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
              rel="noopener noreferrer"
              className="btn-secondary opacity-0 translate-y-4 med-hero-cta"
            >
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <p className="font-inter text-body-lg text-[#737373] leading-relaxed">
            Spanning Greek mezze, coastal grills, garden salads, and shared seafood platters, our Mediterranean menus suit poolside parties, villa lunches, wellness-minded celebrations, and refined corporate dining. Halal sourcing is the baseline, vegetarian and vegan dishes are plentiful, and our team handles styling, service, and pack-down — see how it fits within our wider <Link to="/catering-dubai" className="text-gold hover:text-gold-light underline underline-offset-4 transition-colors">luxury catering in Dubai</Link>, or explore our <Link to="/healthy-catering-dubai" className="text-gold hover:text-gold-light underline underline-offset-4 transition-colors">healthy catering menus</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black section-padding">
        <div className="container-custom">
          ...
          <div className="med-fmt-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {menuHighlights.map((fmt, i) => {
              ...
              return (
                <Link
                  key={i}
                  to={fmt.link}
                  className="med-fmt-card group bg-charcoal p-8 transition-all duration-400 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
                >
      ...
      <section className="bg-black section-padding pt-0">
        <div className="container-custom">
          ...
          <div className="med-uc-grid grid md:grid-cols-2 gap-6">
            {useCases.map((uc, i) => (
              <div key={i} className="med-uc-item bg-charcoal p-8 opacity-0 translate-y-10">
      ...
      <section className="bg-cream section-padding">
        <div className="container-custom max-w-[1000px]">
          <h2 className="font-playfair text-h2 text-black text-center mb-12">
            What Our Mediterranean Catering Includes
          </h2>

          <div className="med-inc-grid grid md:grid-cols-2 gap-6">
            {includedItems.map((item, i) => (
              <div key={i} className="med-inc-item flex gap-3 opacity-0 -translate-x-5">
      ...
      <section className="bg-black py-20">
        <div className="container-custom">
          ...
          <div className="med-gallery grid grid-cols-2 lg:grid-cols-3 gap-4">
            {galleryImages.map((img, i) => (
              <div key={i} className="med-gallery-img aspect-[4/3] overflow-hidden opacity-0 scale-95">
                <img
                  src={img.src}
                  alt={img.alt}
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="med-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="med-faq-item border border-[#E5E5E5] opacity-0 translate-y-5">
                <button
          ...
          <div className="med-loc-grid grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {locations.map((loc) => (
              <Link
                ...
                className="med-loc-item flex items-center gap-2 font-inter text-sm text-[#A3A3A3] hover:text-gold transition-colors opacity-0"
              >
      ...
      <section className="bg-black py-20">
        <div className="container-custom">
          ...
          <div className="med-rel-grid grid md:grid-cols-3 gap-6">
            {relatedServices.map((svc, i) => (
              <Link
                key={i}
                to={svc.link}
                className="med-rel-card group bg-charcoal overflow-hidden transition-all duration-400 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
              >
      ...
      <section className="bg-gradient-to-b from-charcoal to-black py-20">
        <div className="container-custom text-center med-cta opacity-0 translate-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/inquiry?utm_source=mychef.ae&utm_medium=cta_button&utm_campaign=mediterranean-catering-dubai" className="btn-primary">Request a Proposal</Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
              rel="noopener noreferrer"
