    ...
    <div ref={containerRef}>
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
            Cost of party catering, cocktail party catering Dubai price, pool party catering price per person Dubai and cocktail party catering price per person Dubai depend on the same three things: the guest count, the menu, and how much of the work happens in front of people. Party buffet catering near me, private party catering near me and party sandwiches catering near me are covered across the whole city, because the chef travels to your address rather than the other way round. Cocktail party catering packages Dubai start from a set format and get adjusted to your date rather than sold as a fixed box. If you are weighing up best cocktail party catering Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. The cocktail party catering menu Dubai is drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Cocktail making class Dubai and cocktail reception catering Dubai are the same service under another name.
          </p>
