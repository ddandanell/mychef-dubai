...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Dubai Catering Prices Guide', item: 'https://www.mychef.ae/dubai-catering-prices-guide' },
  ],
}
    ...
    <div ref={containerRef}>
      ...
      <NonCateringVisual><section className="relative min-h-[85dvh] md:min-h-[85dvh] md:min-h-[100dvh] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center max-w-[800px] py-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/inquiry" className="btn-primary opacity-0 translate-y-4 price-hero-cta">Request your quote</Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
            Drop-off from AED 90. Staffed buffet from AED 120. Canapés and stations from AED 150. Plated AED 700 to 950. Yacht from AED 280. 5% VAT as its own line. The written quote is the event total.
          </p>
