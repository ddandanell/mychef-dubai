...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Vegetarian Catering Dubai', item: 'https://www.mychef.ae/vegetarian-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'd like a Vegetarian quote in Dubai. Date: __ Guests: __ Area: __"
export default function VegetarianCatering() {
  ...
  return (
    <div ref={containerRef}>
      ...
      <LocationStrip title="Vegetarian catering across Dubai" />
