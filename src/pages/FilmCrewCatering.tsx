...
const WHATSAPP_MESSAGE = encodeURIComponent('Hi myCHEF Dubai, I\'d like to arrange film crew catering in Dubai')
...
const galleryImages = [
  { src: '/service-catering.jpg', alt: 'On-set film crew catering buffet in Dubai' },
  { src: '/menu-meat.jpg', alt: 'Hot grilled main course for a film crew lunch' },
  { src: '/service-events.jpg', alt: 'Location catering setup for a production unit' },
  { src: '/service-corporate.jpg', alt: 'Craft services table for cast and crew' },
  { src: '/menu-appetizer.jpg', alt: 'Fresh craft service snacks on set' },
  { src: '/service-villa.jpg', alt: 'Catering service for a Dubai film shoot' },
]
    ...
    <div ref={containerRef}>
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center max-w-[800px] py-20">
          ...
          <h1 className="font-playfair text-[40px] md:text-[56px] lg:text-[72px] font-semibold text-white leading-tight mb-6 opacity-0 translate-y-10 film-hero-h1">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/inquiry" className="btn-primary opacity-0 translate-y-4 film-hero-cta">
              Request a Film Catering Quote
            </Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
            ...
            {crewFormats.map((fmt, i) => {
              ...
              return (
                <Link
                  key={i}
                  to={fmt.link}
                  className="film-fmt-card group bg-charcoal p-8 transition-all duration-400 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
                >
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="film-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="film-faq-item border border-[#E5E5E5] opacity-0 translate-y-5">
                <button
          ...
          <div className="film-loc-grid grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {locations.map((loc) => (
              <Link
                ...
                className="film-loc-item flex items-center gap-2 font-inter text-sm text-[#A3A3A3] hover:text-gold transition-colors opacity-0"
              >
          ...
          <div className="film-rel-grid grid md:grid-cols-3 gap-6">
            {relatedServices.map((svc, i) => (
              <Link
                key={i}
                to={svc.link}
                className="film-rel-card group bg-charcoal overflow-hidden transition-all duration-400 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
              >
