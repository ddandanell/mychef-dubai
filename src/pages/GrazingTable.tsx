...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. Our chefs build and styles the grazing table at your venue, whether that is a villa, garden, rooftop, or office, and we return to pack down and clear afterwards so you do not have to.',
  },
  {
  ...
  { q: "How does a grazing table compare to a buffet?", a: "A grazing table is a single, abundant, styled centrepiece guests graze from at their own pace, while a buffet is a functional line of dishes for filling plates. Grazing tables lead with visual impact, variety, and mingling, making them ideal for showers, receptions, and celebrations where the food is also a backdrop. If you need a fuller sit-down volume of food, we can pair grazing with our wider [catering in Dubai](/catering-dubai)." },
  { q: "What is the minimum number of guests for a grazing table?", a: "We build grazing tables for intimate groups as well as large celebrations, so there's no rigid cut-off that rules out smaller gatherings. For very small parties we often suggest grazing boards or boxes instead, which give the same artisan feel at a more compact scale. Tell us your headcount and we'll recommend the format that looks and works best." },
  { q: "Do you provide staff to serve and replenish the grazing table?", a: "Serving staff are optional and can be added to your booking if you'd like the table topped up, refreshed, and looked after throughout the event. For many grazing setups the table is designed to be self-serve, so guests help themselves at their own pace while it stays looking abundant. For longer receptions or larger crowds, on-site staff keep the spread full and photogenic from start to finish." },
  { q: "Can you build a grazing table at my villa, garden, or rooftop?", a: "Yes, we build and style grazing tables on-site at villas, gardens, terraces, and rooftops across Dubai, and we handle the full pack-down afterwards. Our team arrives with everything needed to assemble the spread in place, so it looks its best exactly where your guests will gather. We regularly cater in-home celebrations across the city's [villas and private residences](/villas-private-residences)." },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Grazing Table Dubai', item: 'https://www.mychef.ae/grazing-table-dubai' },
  ],
}
    ...
    <div ref={containerRef}>
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
            Grazing table Dubai price depends on the same three things: the guest count, the menu, and how much of the work happens in front of people. Grazing table packages Dubai start from a set format and get adjusted to your date rather than sold as a fixed box. If you are weighing up best grazing table Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. The grazing table menu Dubai is drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Halal grazing table Dubai is planned into the first draft of the menu rather than bolted on at the end.
          </p>
          <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
            Birthday grazing table Dubai is planned around the room and the running order, with chefs, service staff and clear-down included. From a compact grazing platter Dubai hosts order for private villa gatherings to full-length styling, every layout balances artisan cheeses, charcuterie, and seasonal garnishes.
          </p>
