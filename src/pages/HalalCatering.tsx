...
//     subkeywords: "halal catering dubai price" · "halal catering cost per person dubai" · "best halal catering dubai" · "halal catering menu dubai" · "halal caterers dubai" · "halal catering companies dubai" · "best halal food dubai" · "catering foods near me halal" · "is all food in dubai halal" · "dinner near me halal" · "deepavali catering halal" · "event catering halal"
...
const galleryImages = [
  { src: '/menu-meat.webp', alt: 'Halal grilled meats and mains in Dubai' },
  { src: '/menu-appetizer.webp', alt: 'Halal appetizer selection' },
  { src: '/service-events.webp', alt: 'Halal catering at a Dubai event' },
  { src: '/service-catering.webp', alt: 'Halal catering set-up' },
  { src: '/service-villa.webp', alt: 'Villa halal dinner styling' },
  { src: '/menu-dessert.webp', alt: 'Traditional halal dessert display' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Halal Catering Dubai', item: 'https://www.mychef.ae/halal-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'd like a Halal quote in Dubai. Date: __ Guests: __ Area: __"
    ...
    <div ref={containerRef}>
      ...
      <section className="relative min-h-[85dvh] md:min-h-[85dvh] md:min-h-[100dvh] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center max-w-[800px] py-20">
          ...
          <h1 className="font-playfair text-fluid-h1 font-semibold text-white leading-tight mb-6 opacity-0 translate-y-10 hal-hero-h1">
            Halal Catering Dubai
          </h1>
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
            Halal catering Dubai price and halal catering cost per person Dubai depend on the same three things: the guest count, the menu, and how much of the work happens in front of people. Dinner near me halal and catering foods near me halal are covered across the whole city, because the chef travels to your address rather than the other way round. If you are weighing up best halal food Dubai and best halal catering Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. The halal catering menu Dubai is drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Halal caterers Dubai, event catering halal, deepavali catering halal, halal catering companies Dubai and is all food in Dubai halal are planned into the first draft of the menu rather than bolted on at the end.
          </p>
            ...
            {halalFormats.map((fmt, i) => {
              ...
              return (
                <Link
                  key={i}
                  to={fmt.link}
                  className="hal-fmt-card group bg-charcoal p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
                >
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          <h2 className="font-playfair text-fluid-h2 text-black text-center mb-10">
            Halal Catering Dubai: the questions we get before a booking
          </h2>
      ...
      <LocationStrip title="Halal catering across Dubai" />
