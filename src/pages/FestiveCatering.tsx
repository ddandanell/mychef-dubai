...
const festivePages = [
  ...
  },
  {
    ...
    description: 'Canapé receptions, a seated menu or late grazing for a New Year sitting you are hosting.',
    icon: PartyPopper,
  },
  {
    slug: '/ramadan-catering-dubai',
    title: 'Ramadan Catering',
    description: 'Iftar and suhoor at home, majlis or office, timed to prayer.',
    icon: Moon,
  },
  {
    slug: '/iftar-catering-dubai',
    title: 'Iftar Catering',
    description: 'Dates, soup, mains and sweets for Maghrib, sized to the guest list.',
    icon: Sun,
  },
  {
    slug: '/ramadan-catering-dubai',
  ...
  },
  {
    ...
    title: 'Eid Catering',
    description: 'Eid al-Fitr and Eid al-Adha: mezze, grills, rice and sharing platters.',
    icon: Sparkles,
  },
  {
    slug: '/diwali-catering-dubai',
    title: 'Diwali Catering',
    description: 'Indian menus, mithai and chaat stations for a Diwali table at your address.',
    icon: Flame,
  },
  {
    slug: '/brunch-catering-dubai',
    title: 'Brunch Catering',
    description: 'A late morning table: pastries, eggs, fruit and coffee, cooked at your address.',
    icon: UtensilsCrossed,
  },
  {
    slug: '/private-party-catering-dubai',
    title: 'Halloween Catering',
    description: 'A house night with a Halloween date. Food, staff and clear-down at your address.',
    icon: PartyPopper,
  },
  {
    slug: '/private-party-catering-dubai',
    title: 'Easter Catering',
    description: 'Easter brunch or a family roast at home. Mixed ages, then clear-down.',
    icon: Sun,
  },
  {
    slug: '/uae-national-day-catering-dubai',
    title: 'UAE National Day Catering',
    description: '2 December at a home, office or hall you control. Emirati dishes, cooked on site.',
    icon: Sparkles,
  },
]
        ...
        <div className="container-custom max-w-[1100px]">
          <div className="text-center mb-12">
            ...
            <h2 className="font-playfair text-h2 text-black">
              Festive catering Dubai, one date at a time
            </h2>
          </div>
      ...
      <section className="festive-cta bg-gradient-to-b from-black to-charcoal py-20">
        <div className="container-custom text-center opacity-0 translate-y-8">
          ...
          <h2 className="font-playfair text-h2 text-white mb-4">
            Send the date, the occasion and the guest count
          </h2>
          <p className="font-inter text-body-lg text-gray-400 max-w-[600px] mx-auto mb-8">
            Tell us which sitting you are hosting and the address. We send an itemised festive catering Dubai quote, with 5% VAT on its own line.
          </p>
