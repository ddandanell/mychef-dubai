...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Brand Activation Catering Dubai', item: 'https://www.mychef.ae/brand-activation-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'm interested in brand activation catering in Dubai. Date: __ Guests: __ Area: __"
export default function BrandActivationCatering() {
  ...
  return (
    <div ref={containerRef}>
      ...
      <LocationStrip title="Brand activation catering across Dubai" />
