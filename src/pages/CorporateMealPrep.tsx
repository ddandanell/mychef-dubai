...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Corporate Meal Prep Dubai', item: 'https://www.mychef.ae/corporate-meal-prep-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'm interested in corporate meal prep in Dubai. Date: __ Guests: __ Area: __"
export default function CorporateMealPrep() {
  ...
  return (
    <div ref={containerRef}>
      ...
      <LocationStrip title="Corporate meal prep across Dubai" />
