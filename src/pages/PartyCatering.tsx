...
const faqs = [
  ...
  { q: "Do you provide the birthday cake, desserts, and themed styling?", a: "Yes, we design custom cakes, dessert tables, and styling that match your theme, colour palette, and occasion. From pastel baby-shower displays to bold bachelor spreads, the presentation is planned as carefully as the food. Our [pastry chef](/chefs/matteo-pastry-chef) can craft a centrepiece dessert that becomes a talking point of the party." },
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'm planning a party and need catering. Date: __, Guests: __, Venue: __, Party type: __ (via mychef.ae/party-catering-dubai)"
