...
export default function FingerFoodCatering() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Finger Food Catering Dubai | Office & Party Menus | myCHEF"
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          <SectionLabel align="center">DUBAI FINGER FOOD SPECIALISTS</SectionLabel>
      ...
      <section className="bg-black section-padding">
        <div className="container-custom">
          <div className="text-center mb-12">
            <SectionLabel align="center" tone="dark">FINGER FOOD FORMATS</SectionLabel>
      ...
      <LocationStrip title="Finger food catering across Dubai" />
