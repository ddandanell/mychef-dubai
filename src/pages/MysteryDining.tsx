...
export default function MysteryDining() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Mystery Dining Dubai | Private Chef Surprise Menu | myCHEF"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="md-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="md-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
