...
const config: ServicePageConfig = {
  ...
  metaDescription: 'Private chef tasting menus and chef’s table experiences in Dubai for intimate dinners, celebrations and corporate hospitality. Multi-course, served at home.',
