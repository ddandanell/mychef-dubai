...
const faqs = [
  ...
  },
  {
    ...
    a: 'You can message us on WhatsApp, call, or email hello@mychef.ae. We ask for details and, where possible, photos. Most concerns are acknowledged within hours and resolved within one to two business days.',
  },
  {
    ...
    <div ref={containerRef}>
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="qg-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="qg-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
