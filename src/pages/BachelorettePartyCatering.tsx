...
const faqs = [
  ...
  { q: "How do we confirm a booking and secure our date?", a: "To confirm, simply share your date, venue, and guest count and we typically acknowledge enquiries within 15 minutes during business hours. We then prepare a tailored proposal and confirm the booking requirements before securing the date. We keep the process simple and personal from first message to the day itself. Start by sending details through our [contact](/contact) page and we will take it from there." },
]
