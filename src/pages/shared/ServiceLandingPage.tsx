    ...
    <div ref={containerRef}>
        ...
        <div className="relative z-10 container-custom text-center max-w-[800px] py-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to={inquiryLink} className="btn-primary translate-y-4 svc-hero-cta">
              {config.primaryCta || 'Request your quote'}
            </Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
      ...
      <section className="bg-black section-padding">
        <div className="container-custom">
          ...
          <div className="svc-fmt-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="bg-black py-20">
        <div className="container-custom">
          ...
          <div className="svc-rel-grid grid md:grid-cols-3 gap-6">
