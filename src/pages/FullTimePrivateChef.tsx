...
export default function FullTimePrivateChef() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Full-Time Private Chef Dubai | Live-In & Residential Chefs | myCHEF"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="fp-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="fp-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
