...
const useCases = [
  ...
  {
    title: 'An on-site canteen service',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Staff Meals Catering Dubai', item: 'https://www.mychef.ae/staff-meals-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'd like a Staff Meals quote in Dubai. Date: __ Guests: __ Area: __"
export default function StaffMealsCatering() {
  ...
  return (
    <div ref={containerRef}>
      ...
      <section className="bg-black section-padding">
        <div className="container-custom">
          <div className="text-center mb-12">
            <SectionLabel align="center" tone="dark">STAFF MEALS FORMATS</SectionLabel>
      ...
      <LocationStrip title="Staff meal catering across Dubai" />
