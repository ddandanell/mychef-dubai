...
const faqs = [
  ...
  { q: "Are your chefs and kitchens compliant with Dubai food-safety regulations?", a: "Yes — our vetted chef network works to Dubai Municipality food-safety standards, following proper hygiene, temperature control, and safe-handling practices at every event. This matters for corporate clients whose own compliance, HR, and facilities teams need assurance that catering meets local regulatory expectations. We can walk your team through our standards when required for internal approval or venue clearance." },
