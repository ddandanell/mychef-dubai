...
export default function MyChefCertified() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="MyChef Certified Chefs Dubai | Vetting & Quality Standard | myCHEF"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          <h2 className="font-playfair text-fluid-h2 text-black text-center mb-10">
            MyChef Certified Questions
          </h2>

          <div className="mc-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="mc-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
