...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Product Launch Catering Dubai', item: 'https://www.mychef.ae/product-launch-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'm interested in product launch catering in Dubai. Date: __ Guests: __ Area: __"
      ...
      <section className="bg-black section-padding pt-0">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <h2 className="font-playfair text-h2 text-white">
              Catering for different launch settings
            </h2>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          <h2 className="font-playfair text-fluid-h2 text-black text-center mb-10">
            Product Launch Catering Dubai: the questions we get before a booking
          </h2>
