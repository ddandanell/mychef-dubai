...
export default function PostpartumMealPrep() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Postpartum Meal Prep Dubai | New Mother Recovery Meals | myCHEF"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="ppm-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="ppm-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
