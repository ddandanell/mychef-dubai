      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <div className="apd-intro-text opacity-0 translate-y-8">
            ...
            <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
              Private chef apartment Dubai price depends on the same three things: the guest count, the menu, and how much of the work happens in front of people. A private dinner in Dubai that fits an apartment is this format: two to eight guests, the chef in your kitchen, then the kitchen left as found. Apartment private dining packages Dubai start from a set format and get adjusted to your date rather than sold as a fixed box. If you are weighing up best private chef for apartment Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. Apartment dinner party Dubai is run at the address you give us: we bring the equipment, cook on site and leave the space as we found it.
            </p>
            <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
