...
export default function ApartmentPrivateDining() {
  ...
  return (
    <div ref={containerRef}>
      <SEO
        title="Apartment Private Dining Dubai | Private Chef for 2–8 Guests | myCHEF"
      ...
      <section className="bg-white py-20">
        <div className="container-custom max-w-[800px]">
          ...
          <div className="apd-faq space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="apd-faq-item border border-gray-200 opacity-0 translate-y-5">
                <button
