...
const config: OccasionPageConfig = {
  ...
  introNodes: (
    <>
      ...
      <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
        Desert dining Dubai price and desert dining price per person Dubai depend on the same three things: the guest count, the menu, and how much of the work happens in front of people. Desert dining packages Dubai start from a set format and get adjusted to your date rather than sold as a fixed box. If you are weighing up best desert dining Dubai, best desert dinner Dubai and luxury desert dining Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. The desert dining menu Dubai is drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Halal desert dining Dubai is planned into the first draft of the menu rather than bolted on at the end. Private desert dining Dubai, desert dinner Dubai private, desert dining experience Dubai and desert dinner experience Dubai are run at the address you give us: we bring the equipment, cook on site and leave the space as we found it.
      </p>
