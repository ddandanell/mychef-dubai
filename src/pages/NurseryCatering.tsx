...
const galleryImages = [
  { src: '/service-catering.webp', alt: 'Soft, balanced nursery meal catering in Dubai' },
  { src: '/menu-appetizer.webp', alt: 'Fresh fruit and gentle snacks for young children' },
  { src: '/service-corporate.webp', alt: 'Nursery catering preparation set-up' },
  { src: '/service-events.webp', alt: 'Catering service for a Dubai nursery' },
  { src: '/menu-seafood.webp', alt: 'Nutritious gentle main course for toddlers' },
  { src: '/service-villa.webp', alt: 'Wholesome catering for young children in Dubai' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Nursery Catering Dubai', item: 'https://www.mychef.ae/nursery-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'd like a Nursery quote in Dubai. Date: __ Guests: __ Area: __"
  ...
  return (
    <div ref={containerRef}>
      <SEO
        ...
        description="Nursery catering in Dubai with soft, balanced meals, allergen-safe preparation, halal menus, and hygiene-first standards for young children. Request your."
      ...
      <section className="relative min-h-[85dvh] md:min-h-[85dvh] md:min-h-[100dvh] flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center max-w-[800px] py-20">
          ...
          <h1 className="font-playfair text-fluid-h1 font-semibold text-white leading-tight mb-6 opacity-0 translate-y-10 nur-hero-h1">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/inquiry?utm_source=mychef.ae&utm_medium=cta_button&utm_campaign=nursery-catering-dubai" className="btn-primary opacity-0 translate-y-4 nur-hero-cta">Get a Tailored Quote</Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          <SectionLabel align="center">GENTLE NUTRITION FOR LITTLE ONES</SectionLabel>
      ...
      <section className="bg-black section-padding">
        <div className="container-custom">
          <div className="text-center mb-12">
            <SectionLabel align="center" tone="dark">NURSERY CATERING FORMATS</SectionLabel>
            ...
            {nurseryFormats.map((fmt, i) => {
              ...
              return (
                <Link
                  key={i}
                  to={fmt.link}
                  className="nur-fmt-card group bg-charcoal p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
                >
      ...
      <section className="bg-black section-padding pt-0">
        <div className="container-custom">
          <div className="text-center mb-12">
            <SectionLabel align="center" tone="dark">HOW WE SUPPORT NURSERIES</SectionLabel>
            <h2 className="font-playfair text-h2 text-white">
          ...
          <div className="nur-loc-grid grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {locations.map((loc) => (
              <Link
                ...
                className="nur-loc-item flex items-center gap-2 font-inter text-sm text-gray-400 hover:text-gold transition-colors opacity-0"
              >
          ...
          <div className="nur-rel-grid grid md:grid-cols-3 gap-6">
            {relatedServices.map((svc, i) => (
              <Link
                key={i}
                to={svc.link}
                className="nur-rel-card group bg-charcoal overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] opacity-0 translate-y-12"
              >
      ...
      <LocationStrip title="Nursery catering across Dubai" />
      ...
      <section className="bg-gradient-to-b from-charcoal to-black py-20">
        <div className="container-custom text-center nur-cta opacity-0 translate-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/inquiry?utm_source=mychef.ae&utm_medium=cta_button&utm_campaign=nursery-catering-dubai" className="btn-primary">Get a Tailored Quote</Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
              rel="noopener noreferrer"
