...
const config: DietaryPageConfig = {
  ...
  introNodes: (
    <>
      ...
      <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
        Jain catering Dubai price and Jain catering cost per person Dubai depend on the same three things: the guest count, the menu, and how much of the work happens in front of people. Jain catering packages Dubai start from a set format and get adjusted to your date rather than sold as a fixed box. If you are weighing up best Jain catering Dubai, the things worth checking are the named chef, the itemised quote and who buys the ingredients. The Emirates Jain meal menu and Jain catering menu Dubai are drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Jain food rules and Jain wedding catering Dubai are planned into the first draft of the menu rather than bolted on at the end. Satvik catering Dubai and no onion no garlic catering Dubai are the same service under another name.
      </p>
