...
const faqs = [
  ...
  { q: "How much does New Year's Eve catering cost in Dubai?", a: "New Year's Eve catering in Dubai is priced by custom quote, because the cost depends on your guest count, menu format, staffing, and venue rather than a fixed per-head rate. Once you share your date, headcount, and vision, we build a detailed proposal covering food, drinks, staff, and logistics, and 5% VAT applies. For a broader sense of how our pricing works, see our [private chef prices in Dubai](/private-chef-dubai/pricing)." },
