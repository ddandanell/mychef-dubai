...
const faqs = [
  ...
  { q: "Are weekday or off-peak bookings cheaper than weekends?", a: "Weekday and off-peak dates can offer better value and easier availability than busy weekends, holidays, and peak season. If your date is flexible, mentioning that when you request a quote helps us match you with the best chef and a more efficient price. Fixed dates around New Year, Eid, and major holidays tend to book out first and sit at the top of the range." },
