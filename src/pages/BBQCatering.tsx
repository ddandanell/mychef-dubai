...
const faqs = [
  ...
  { q: "How much does BBQ catering in Dubai cost per person?", a: "BBQ catering in Dubai is priced by custom quote, because the per-person cost depends on your guest count, the cuts and seafood you choose, and how many live grill stations you want. Once you share a few details we build a transparent, all-inclusive proposal covering the food, chefs, equipment, service, and cleanup, with 5% VAT applied. For a fuller picture of what shapes a grill budget, see our [private chef prices in Dubai](/private-chef-prices-dubai)." },
