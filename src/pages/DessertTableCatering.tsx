...
const WHATSAPP_MESSAGE = encodeURIComponent('Hi myCHEF Dubai, I\'d like to plan a dessert table in Dubai')
    ...
    <div ref={containerRef}>
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center bg-black overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'url(/menu-dessert.jpg)' }}
        />
        ...
        <div className="relative z-10 container-custom text-center max-w-[800px] py-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/inquiry" className="btn-primary opacity-0 translate-y-4 des-hero-cta">
              Request a Dessert Table Quote
            </Link>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
