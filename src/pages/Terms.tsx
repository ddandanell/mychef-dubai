...
const sections = [
  ...
  },
  {
    title: 'Contact',
    content: (
      <p>For questions about these terms, please contact us at <a href="mailto:info@mychef.id" className="text-gold hover:underline">info@mychef.id</a> or via WhatsApp.</p>
    ),
  },
]
