...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Production Catering Dubai', item: 'https://www.mychef.ae/production-catering-dubai' },
  ],
}
...
const PAGE_WHATSAPP_MESSAGE = "Hi myCHEF Dubai, I'd like a Production quote in Dubai. Date: __ Guests: __ Area: __"
  ...
  return (
    <div ref={containerRef}>
      ...
      <section className="bg-black section-padding">
        <div className="container-custom">
          <div className="text-center mb-12">
            <SectionLabel align="center" tone="dark">PRODUCTION FORMATS</SectionLabel>
      ...
      <section className="bg-black section-padding pt-0">
        <div className="container-custom">
          <div className="text-center mb-12">
            <SectionLabel align="center" tone="dark">WHO WE FEED</SectionLabel>
            <h2 className="font-playfair text-h2 text-white">
      ...
      <LocationStrip title="Production catering across Dubai" />
