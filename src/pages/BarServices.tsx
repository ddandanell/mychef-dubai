    ...
    <div ref={containerRef}>
      ...
      <section className="bg-white section-padding">
        <div className="container-custom max-w-[820px] text-center">
          ...
          <p className="font-inter text-body-lg text-gray-500 leading-relaxed mb-5">
            Mobile bar hire Dubai price, oyster bar catering price per person Dubai and mocktail bar catering price per person Dubai depend on the same three things: the guest count, the menu, and how much of the work happens in front of people. Bar hire packages Dubai start from a set format and get adjusted to your date rather than sold as a fixed box. The mocktail bar catering menu Dubai is drafted around the occasion, the season and the dietary list, and you change it before anything is confirmed. Event bartender Dubai, mocktail bar birthday party Dubai and bartender for birthday party Dubai are planned around the room and the running order, with chefs, service staff and clear-down included. Bartender hire Dubai is the same booking: a vetted chef, matched to your kitchen and your menu. Mocktail bar Dubai and mocktail station Dubai are the same service under another name.
          </p>
