  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'h1': ['clamp(2rem, 4vw, 2.75rem)', { lineHeight: '1.12', letterSpacing: '-0.02em' }],
        'h2': ['clamp(1.75rem, 3vw, 2.15rem)', { lineHeight: '1.18', letterSpacing: '-0.015em' }],
        'h3': ['clamp(1.375rem, 2vw, 1.5rem)', { lineHeight: '1.25', letterSpacing: '-0.01em' }],
        ...
        'fluid-display': ['clamp(2.5rem, 4.2vw, 3.75rem)', { lineHeight: '1.05', letterSpacing: '-0.02em' }],
        'fluid-h1': ['clamp(2rem, 3.4vw, 2.85rem)', { lineHeight: '1.12', letterSpacing: '-0.02em' }],
        'fluid-h2': ['clamp(1.75rem, 2.6vw, 2.15rem)', { lineHeight: '1.18', letterSpacing: '-0.015em' }],
        'fluid-h3': ['clamp(1.375rem, 2vw, 1.5rem)', { lineHeight: '1.25', letterSpacing: '-0.01em' }],
      },
      spacing: {
        'xs': '4px',
        'sm': '8px',
